...
- Paste in ```https://github.com/QuantumCalzone/UnityShortcuts.git#upm```
- Click the **Add** button

### Via 2019.3 and eariler
- In your Unity Project, open up the manifest.json file located in your Packages folder
- below ```"dependencies": {``` add the line ```"com.quantumcalzone.unityshortcuts": "https://github.com/QuantumCalzone/UnityShortcuts.git#upm",```
